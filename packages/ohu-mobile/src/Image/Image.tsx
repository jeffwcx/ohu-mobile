...
export default defineComponent<ImageProps, ImageEvents, ImageScopedSlots>(
  'image',
)
  ...
  .create({
    props: {
      ...
      lazy: props
        .ofType<Omit<LazyloadProps, 'src' | 'asyncComponent'> | boolean>()
        .default(false),
    ...
    render() {
      ...
      return <Lazyload {...lazyloadProps}>{placeholder}</Lazyload>;
    },
  });
