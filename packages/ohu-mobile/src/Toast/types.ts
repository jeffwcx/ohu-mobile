...
} from '../_utils/createPopupMethodApi';
...
export declare function toastInfo(
  content: string,
  duration?: number,
  options?: PopupOutSideProps & MethodBaseOptions,
): PopupDepositComponent;
export declare function toastLoading(
  content: string,
  options?: PopupOutSideProps & MethodBaseOptions,
): PopupDepositComponent;

export type ToastInfoOptions =
  | Parameters<typeof toastInfo>
  | Parameters<typeof toastLoading>;
