...
import { CollapseProps, CollapseEvents, CollapseExpandIconPosition, CollapseValue } from './types';
import { IconDef } from '../types';


export default defineAncestorComponent<CollapseProps, CollapseEvents>('collapse')
  .create({
    model: {
      prop: 'value',
      event: 'change',
    ...
    props: {
      expandIcon: props.ofType<IconDef | null>().default(() => ArrowDownSOutlined),
      expandIconPosition: props.ofType<CollapseExpandIconPosition>().default('right'),
    ...
    render() {
      ...
      return (
        <div class={root}>{$slots.default}</div>
      );
    },
  });
