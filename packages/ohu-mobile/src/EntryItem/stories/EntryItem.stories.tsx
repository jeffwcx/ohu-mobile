      ...
      return (
        <div>
          <Card shadow>
            <Card.Header bold>
              我的订单
              <Button slot="extra" type="link" size="sm">
                查看全部服务 &gt;
              </Button>
            </Card.Header>
            <div style="display: flex; flex-flow: row wrap;">
          ...
          <Card>
            <EntryItem style="width: 25%;" textSize="xsm" icon={HomeOutlined}>
              首页
            </EntryItem>
            <EntryItem style="width: 25%;" textSize="xsm" icon={InboxOutlined}>
              就医
            </EntryItem>
            <EntryItem style="width: 25%;" textSize="xsm" icon={CheckOutlined}>
              体检
            </EntryItem>
            <EntryItem style="width: 25%;" textSize="xsm" icon={UserOutlined}>
              我的
            </EntryItem>
          </Card>
          <EntryItem
...
export const OnlyText = () =>
  Vue.extend({
    render() {
      return (
        <Card shadow>
          <EntryItem style="width: 33.3333%" badge={{ type: 'dot' }}>
            热度
          </EntryItem>
        </Card>
      );
