        ...
        {new Array(3).fill('').map(() => {
          return (
            <Skeleton
              title
              rows={2}
              style="box-sizing: border-box; height: 120px; width: 100%; padding: 15px"
            >
              <Skeleton
        ...
        <div>
          ...
          <Lazyload
            ...
            scopedSlots={{
              error: ({ reload }) => {
                return (
                  <div
                    style="height: 144px; width: 240px; background: #EEE; text-align: center; color: #333; font-size: 14px;"
                    onClick={() => {
          ...
          >
            <Skeleton
              ...
              title
              rows={2}
              style="box-sizing: border-box; height: 144px; width: 240px; padding: 15px"
            >
              <Skeleton shape="rect"></Skeleton>
            </Skeleton>
          </Lazyload>
