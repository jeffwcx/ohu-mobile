...
import '../../Card/style';
import Carousel, { CarouselSlideDirection } from '../index';
import '../style';
import Vue from 'vue';
    ...
    render() {
      return (
        <div>
          ...
          <Card shadow>
            <Card.Header>step perPage center</Card.Header>
          ...
          <Card shadow>
            <Card.Header>autoSize</Card.Header>
            <Carousel autoSize>
              <div class="basic-demo-item" style={{ width: '200px' }}>
                1
              </div>
              <div class="basic-demo-item" style={{ width: '100px' }}>
                2
              </div>
              <div class="basic-demo-item" style={{ width: '400px' }}>
                3
              </div>
              <div class="basic-demo-item" style={{ width: '400px' }}>
                4
          ...
          <Card shadow>
            <Card.Header>autoplay</Card.Header>
          ...
          <Card shadow>
            <Card.Header>autoplay loop</Card.Header>
      ...
      return (
        <div>
          <Card shadow>
            ...
            <Carousel
              direction="vertical"
              style={{ height: '200px', background: '#aaa' }}
              v-model={this.v1}
            >
          ...
          <Card shadow>
            ...
            <Carousel
              ...
              perPage={2}
              moveStep={1}
              style={{ background: '#aaa', height: '200px' }}
            >
              <div class="vertical-demo-item">1</div>
              <div class="vertical-demo-item">2</div>
              <div class="vertical-demo-item">3</div>
          ...
          <Card shadow>
            ...
            <Carousel
              ...
              style={{ background: '#aaa', height: '200px' }}
            >
              <div class="basic-demo-item" style={{ height: '200px' }}>
                1
              </div>
              <div class="basic-demo-item" style={{ height: '100px' }}>
                2
              </div>
              <div class="basic-demo-item" style={{ height: '400px' }}>
                3
              </div>
              <div class="basic-demo-item" style={{ height: '400px' }}>
                4
