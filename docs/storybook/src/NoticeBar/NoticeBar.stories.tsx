    ...
    return (
      <div>
        ...
        <Card divider shadow>
          ...
          <NoticeBar icon={VolumeDownOutlined} scrollable speed={30}>初次使用，您有15分钟体验时间, 初次使用，您有15分钟体验时间, 初次使用，您有15分钟体验时间</NoticeBar>
        </Card>
        <Card divider shadow>
          <Card.Header>closable</Card.Header>
          <NoticeBar icon={VolumeDownOutlined} scrollable delay={2000} action="closable">初次使用，您有15分钟体验时间, 初次使用，您有15分钟体验时间, 初次使用，您有15分钟体验时间</NoticeBar>
        </Card>
        <Card divider shadow>
        ...
        <Card divider shadow>
          ...
          <NoticeBar icon={VolumeDownOutlined} action="closable" multiline>初次使用，您有15分钟体验时间, 初次使用，您有15分钟体验时间, 初次使用，您有15分钟体验时间</NoticeBar>
        </Card>
        <Card divider shadow>
