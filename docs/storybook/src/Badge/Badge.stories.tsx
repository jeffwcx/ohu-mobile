...
export const position = () => Vue.extend({
  render() {
    const container = (
      <div style="width: 200px;height: 80px;border: 1px solid #eee;">
      </div>
    );
    return (
      <div>
        <Badge type="corner" color="gold" text="推荐" style="border-radius: 6px;">
          {container}
        </Badge>
        ...
        <Badge type="corner" position="down-right" text="已满" fontColor="yellow" color="red">
          {container}
        </Badge>
      </div>
    );
    ...
    return (
      <div style="padding: 10px;">
        ...
        <Card shadow>
          ...
          <Badge type="tag" color="orange" text="1" style="margin-right: 30px;">
            <div style="width: 40px; height: 40px; background: #eee;"></div>
          </Badge>
          <Badge type="tag" text={999} style="font-size: 24px; margin-right: 30px;">
